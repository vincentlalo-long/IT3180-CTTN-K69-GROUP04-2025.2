...
import { Trophy, Users, RefreshCw, ChevronUp, ChevronDown, CalendarDays, Megaphone } from "lucide-react";
...
export function PlayerLeaguePage() {
  ...
  const [leagueTab, setLeagueTab] = useState<"REGISTRATION" | "ANNOUNCEMENTS">("REGISTRATION");
